...
public class guia6ejercicio3 {
    ...
    public static void main(String[] args) {
        ...
        Operacion n1= new Operacion();
         ...
         System.out.println("Resultado de la suma"+ n1.sumar() );
         
         System.out.println("Resultado de la resta"+n1.restar() );
         
         System.out.println("Resultado de la multiplicacion "+ n1.multiplicar());
         
         System.out.println("Resultado de la division  " + n1.dividir());
