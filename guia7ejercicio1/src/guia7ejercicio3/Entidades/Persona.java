 ...
 */
package guia7ejercicio3.Entidades;
...
public class Persona {
    ...
    public Persona(String nombre, int edad, String sexo, double peso, double altura, double DNI, String Nacionalidad) {
        this.nombre = nombre;
        this.edad = edad;
        this.sexo = sexo;
        this.peso = peso;
    ...
    public String toString() {
        return "Personas{" + "nombre=" + nombre + ", edad=" + edad + ", sexo=" + sexo + ", peso=" + peso + ", altura=" + altura + ", DNI=" + DNI + ", Nacionalidad=" + nacionalidad + '}';
    }
