 ...
 */
package guia8ejercicios2extras.Entidades;
...
public class Ahorcado {
    ...
    public Ahorcado(char[] palabraABuscar, int cantidadDeJugadasMaximas) {
        this.palabraABuscar = new char[palabraABuscar.length];
